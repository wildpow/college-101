!(function(e, t) {
  ...
  (function(e) {
      ...
      var a,
        u = {
          adapter: ("undefined" != typeof XMLHttpRequest
            ? (a = r(106))
            : "undefined" != typeof process && (a = r(111)),
          a),
          transformRequest: [
            function(e, t) {
              return (
      ...
      ["abort", "aborted", "error", "socket", "timeout"].forEach(function(e) {
        ...
        (p.prototype._performRequest = function() {
          ...
          if (t) {
            ...
            for (var s in ((this._currentUrl = n.format(this._options)),
    ...
    function(e, t, r) {
      ...
      t.handler = function(e, t, r) {
        n({
          ...
          .then(e => {
            console.log(e),
              r(null, { statusCode: 2e3, body: process.env.GREETING });
          })
          .catch(e => {
            console.log(e), r(new Error("Something went wrong"));
          });
      };
    },
    function(e, t, r) {
      ...
      e.exports = function(e) {
        return new Promise(function(t, r) {
          ...
          if (
            ...
            else if (n.isArrayBuffer(g)) g = new Buffer(new Uint8Array(g));
            else {
              if (!n.isString(g))
                return r(
                  d(
            ...
            C["Content-Length"] = g.length;
          }
          var v = void 0;
          e.auth &&
            (v = (e.auth.username || "") + ":" + (e.auth.password || ""));
          var y = f.parse(e.url),
            b = y.protocol || "http:";
          if (!v && y.auth) {
            var x = y.auth.split(":");
          ...
          v && delete C.Authorization;
          var w = "https:" === b,
            R = w ? e.httpsAgent : e.httpAgent,
            F = {
          ...
          e.socketPath
            ...
            : ((F.hostname = y.hostname), (F.port = y.port));
          var E,
            _ = e.proxy;
          if (!_ && !1 !== _) {
            var O = b.slice(0, -1) + "_proxy",
              A = process.env[O] || process.env[O.toUpperCase()];
            if (A) {
              var B = f.parse(A);
              if (((_ = { host: B.hostname, port: B.port }), B.auth)) {
                var j = B.auth.split(":");
                _.auth = { username: j[0], password: j[1] };
              }
            }
          }
          if (
            ...
            ((F.hostname = _.host),
            (F.host = _.host),
            (F.headers.host = y.hostname + (y.port ? ":" + y.port : "")),
            (F.port = _.port),
            (F.path =
              b + "//" + y.hostname + (y.port ? ":" + y.port : "") + F.path),
            _.auth)
          ) {
            var T = new Buffer(
            ...
            F.headers["Proxy-Authorization"] = "Basic " + T;
          }
          e.transport
            ? (E = e.transport)
            : 0 === e.maxRedirects
          ...
          var S = E.request(F, function(n) {
            if (!S.aborted) {
              ...
              if ("stream" === e.responseType) (a.data = s), o(t, r, a);
              else {
                var u = [];
                s.on("data", function(t) {
                  u.push(t),
                    e.maxContentLength > -1 &&
                      Buffer.concat(u).length > e.maxContentLength &&
                      r(
                        d(
          ...
          S.on("error", function(t) {
            ...
            e.cancelToken &&
              e.cancelToken.promise.then(function(e) {
                S.aborted || (S.abort(), r(e));
              }),
            n.isStream(g) ? g.pipe(S) : S.end(g);
        });
      };
    },
    function(e, t) {
    ...
    function(e, t, r) {
      var n = r(118),
        o = r(119);
      ((t = e.exports = r(93)).init = function(e) {
        e.inspectOpts = {};
