  ...
  (function(e) {
    ...
    function(e, t, r) {
      ...
      var n = r(5).Buffer,
        ...
        s = {}.hasOwnProperty,
        c = r(13),
        u = ["api_key", "idempotency_key", "stripe_account", "stripe_version"],
        d = (e.exports = {
          ...
          stringifyRequestData: function(e) {
            return o.stringify(e, { arrayFormat: "brackets" });
          },
          makeURLInterpolator: (function() {
            ...
            return function(t) {
              ...
              return function(e) {
                return r.replace(/\{([\s\S]+?)\}/g, function(t, r) {
          ...
          encodeParamWithIntegerIndexes: function(e, t) {
            return void 0 !== t[e] && (t[e] = d.arrayToObject(t[e])), t;
          },
          ...
          secureCompare: function(e, t) {
            if (((e = n.from(e)), (t = n.from(t)), e.length !== t.length))
              return !1;
            if (a.timingSafeEqual) return a.timingSafeEqual(e, t);
            for (var r = e.length, i = 0, o = 0; o < r; ++o) i |= e[o] ^ t[o];
            return 0 === i;
          },
          ...
          checkForStream: function(e) {
            return !(!e.file || !e.file.data) && e.file.data instanceof i;
          },
      ...
      e.exports = n.extend({
        ...
        retrieve: function(e) {
          return "string" == typeof e
            ...
            : ((null !== e && void 0 !== e) || [].shift.apply(arguments),
    ...
    function(e, t, r) {
      ...
      (c.DEFAULT_HOST = "api.stripe.com"),
        ...
        (c.DEFAULT_TIMEOUT = r(4).createServer().timeout),
    ...
    function(e, t, r) {
      ...
      e.exports = n.extend({
        ...
        create: i({ method: "POST", required: ["currency"] }),
        pay: i({
          method: "POST",
          path: "/{orderId}/pay",
          urlParams: ["orderId"],
    ...
    function(e, t, r) {
      ...
      e.exports = n.extend({
        ...
        create: i({ method: "POST", required: ["name"] }),
      });
    },
    function(e, t, r) {
      "use strict";
      ...
      var n = r(12),
        ...
        a = {
          ...
          constructEvent: function(e, t, r, n) {
            var i = JSON.parse(e);
            return (
              this.signature.verifyHeader(e, t, r, n || a.DEFAULT_TOLERANCE), i
            );
          },
        },
        s = {
          ...
          verifyHeader: function(e, t, r, n) {
            ...
            })(t, this.EXPECTED_SCHEME);
            if (!a || -1 === a.timestamp)
              throw new o.StripeSignatureVerificationError({
                message:
            ...
            var s = this._computeSignature(a.timestamp + "." + e, r);
            if (!!!a.signatures.filter(i.secureCompare.bind(i, s)).length)
              throw new o.StripeSignatureVerificationError({
                message:
                  "No signatures found matching the expected signature for payload. Are you passing the raw request body you received from Stripe? https://github.com/stripe/stripe-node#webhook-signing",
                detail: { header: t, payload: e },
              });
            var c = Math.floor(Date.now() / 1e3) - a.timestamp;
            if (n > 0 && c > n)
              throw new o.StripeSignatureVerificationError({
