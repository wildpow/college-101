            ...
            var c = (function(e, t, r, o) {
              for (
                ...
                var m,
                  ...
                  g = c[h],
                  y = i.test(g);
                if ("id" == (g = g.replace(i, "")) && "string" != typeof v)
    ...
    function(e, t, r) {
      ...
      var n = r(10),
        ...
        c = function e(t, r, i, o, a, c, u, d, p, l, h, f) {
          ...
          for (var I = 0; I < v.length; ++I) {
            ...
            (a && null === m[P]) ||
              (g = Array.isArray(m)
                ? g.concat(e(m[P], i(r, P), i, o, a, c, u, d, p, l, h, f))
                : g.concat(
                    e(
                      m[P],
                      r + (p ? "." + P : "[" + P + "]"),
      ...
      e.exports = function(e, t) {
        ...
        "function" == typeof a.filter
          ? (r = (I = a.filter)("", r))
          : Array.isArray(a.filter) && (y = I = a.filter);
        var E,
          b = [];
        ...
        E =
          a.arrayFormat in o
            ...
            : "indices";
        var S = o[E];
        y || (y = Object.keys(r)), f && y.sort(f);
        for (var T = 0; T < y.length; ++T) {
          var x = y[T];
          (p && null === r[x]) ||
            (b = b.concat(c(r[x], x, S, d, p, l ? h : null, I, f, m, v, P, g)));
        }
        var _ = b.join(u),
